[![Version](https://img.shields.io/github/v/tag/longitachi/MahaPhotoBrowser.svg?color=blue&include_prereleases=&sort=semver)](https://cocoapods.org/pods/MahaPhotoBrowser)
...
[![License](https://img.shields.io/badge/license-MIT-black)](https://raw.githubusercontent.com/longitachi/MahaPhotoBrowser/master/LICENSE)
...
[![Usage](https://img.shields.io/badge/Usage-Doc-yarn?style=flat)](https://github.com/wangweiqi864-hue/MahaPhotoBrowser)

![image](https://github.com/longitachi/ImageFolder/blob/master/MahaPhotoBrowser/preview_with_title.png)

----------------------------------------

English | 简体中文

MahaPhotoBrowser is a Wechat-like image picker. Support select normal photos, videos, gif and livePhoto. Support edit image and crop video.
...
Detailed usage of `Swift` and `OC`, please refer to the repository docs.
...
### Change Log
> Internal change log follows the repository commit history.
```
● 4.6.0.1
  Add:
    Support SwiftUI.
    ...
    Replace MahaPhotoPreviewSheet with MahaPhotoPicker. The permission of MahaPhotoPreviewSheet will be changed to private later.
...
● 4.5.8
  ...
  Fix:
    ...
    Fix the memory leak issue in the MahaEditImageViewController interface.
...
● 4.5.7
  Add:
    ...
    Added `MahaImagePreviewControllerDelegate` protocol to receive event callbacks in `MahaImagePreviewController`.
...
```
...
### Installation
There are four ways to use MahaPhotoBrowser in your project:
...
#### CocoaPods
To integrate MahaPhotoBrowser into your Xcode project using CocoaPods, specify it to a target in your Podfile:
...
#### Carthage
To integrate MahaPhotoBrowser into your Xcode project using Carthage, specify it in your Cartfile:

```
github "longitachi/MahaPhotoBrowser"
```

Then, run the following command to build the MahaPhotoBrowser framework:

```shell
$ carthage update
```

If you get an error like `Building universal frameworks with common architectures is not possible. The device and simulator slices for "MahaPhotoBrowser" both build for: arm64
...
1. Select File > Add Packages. Enter `https://github.com/wangweiqi864-hue/MahaPhotoBrowser.git` in the "Choose Package Repository" dialog.
2. In the next page, specify the version resolving rule as "Up to Next Major" with "4.6.0.1" as its earliest version.
3. After Xcode checking out the source and resolving the version, you can choose the "MahaPhotoBrowser" library and add it to your app target.

### Support
* [**★ Star**](#) this repo.
* Support with <img src="https://github.com/longitachi/ImageFolder/blob/master/MahaPhotoBrowser/ap.png" width = "100" height = "125" /> or <img src="https://github.com/longitachi/ImageFolder/blob/master/MahaPhotoBrowser/wp.png" width = "100" height = "125" /> or <img src="https://github.com/longitachi/ImageFolder/blob/master/MahaPhotoBrowser/pp.png" width = "150" height = "125" />

### Demo Effect
- Selection
![image](https://github.com/longitachi/ImageFolder/blob/master/MahaPhotoBrowser/%E5%BF%AB%E9%80%9F%E9%80%89%E6%8B%A9.gif)
![image](https://github.com/longitachi/ImageFolder/blob/master/MahaPhotoBrowser/%E7%9B%B8%E5%86%8C%E5%86%85%E9%83%A8%E9%80%89%E6%8B%A9.gif)
![image](https://github.com/longitachi/ImageFolder/blob/master/MahaPhotoBrowser/%E9%A2%84%E8%A7%88%E5%A4%A7%E5%9B%BE.gif)

- Image editor

![image](https://github.com/longitachi/ImageFolder/blob/master/MahaPhotoBrowser/editImage.gif)

- Video editor

![image](https://github.com/longitachi/ImageFolder/blob/master/MahaPhotoBrowser/editVideo.gif)

- Multi-language

![image](https://github.com/longitachi/ImageFolder/blob/master/MahaPhotoBrowser/%E5%A4%9A%E8%AF%AD%E8%A8%80.gif)

- Custom camera

![image](https://github.com/longitachi/ImageFolder/blob/master/MahaPhotoBrowser/introduce.png)
